                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <form class="form-inline my-2 my-lg-0 float-right">
                                <input name="buscarpor"class="form-control mr-sm-2" type="buscar" placeholder="Buscar" aria-label="Buscar" value="{{$buscarpor}}">
                                <button class="btn btn-primary btn-sm float-right" type="submit">Buscar</button>
                              </form>
